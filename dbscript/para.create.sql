--
-- SQLiteStudio v3.4.4 生成的文件，周一 4月 24 16:51:43 2023
--
-- 所用的文本编码：UTF-8
--
...
INSERT INTO t_checkPorts (seq, cmdType, cmdParam, resultType, resultValue, resultSign, description, isEnable, childTableName) VALUES (1, 3, '317', 1, '(f)=>f>=210.0&&f<=230.0', 4, 'RS485-1测试', 1, NULL);
INSERT INTO t_checkPorts (seq, cmdType, cmdParam, resultType, resultValue, resultSign, description, isEnable, childTableName) VALUES (2, 3, '318', 1, '(f)=>f>=210.0&&f<=230.0', 4, 'RS485-2测试', 1, NULL);
INSERT INTO t_checkPorts (seq, cmdType, cmdParam, resultType, resultValue, resultSign, description, isEnable, childTableName) VALUES (3, 3, '319', 1, '(f)=>f>=210.0&&f<=230.0', 4, 'RS485-3测试', 1, NULL);
INSERT INTO t_checkPorts (seq, cmdType, cmdParam, resultType, resultValue, resultSign, description, isEnable, childTableName) VALUES (4, 3, '320', 1, '(f)=>f>=210.0&&f<=230.0', 4, 'RS485-1测试', 1, NULL);
INSERT INTO t_checkPorts (seq, cmdType, cmdParam, resultType, resultValue, resultSign, description, isEnable, childTableName) VALUES (5, 3, '321', 1, '(f)=>f>=210.0&&f<=230.0', 4, 'RS485-1测试', 1, NULL);
